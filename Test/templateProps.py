...
path = r'.\Revizto buffer\TemplateTest.aptmpl'

values = ['AISC 14.1','AISC 15.0']
...
with open(path, "rb") as f:
    ...
    tabName  = template['3']['2']['1']['2']['2']['2']['2']['2']['2'].decode()
    #propName = template['3']['2']['1']['2']['2']['2']['2']['3']['2'].decode()
    propName = "Code Name"
...
filename = '.\Revizto buffer\output.aptmpl'
