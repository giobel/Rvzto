...
with open(path, "rb") as f:
    ...
    print ('data decoded')
    print (decdata)
    searchsetIterator(decdata)
    #print('ticks ' + ticks_to_datetime(638396604*1_000_000_000).replace(tzinfo=timezone.utc).strftime('%Y-%m-%d %H:%M'))
    #print (decdata['4'][2]['8']['2'][8])

    #decdata['4'][2]['8']['2'].append({'1': 2})
